...
function razil_org_defaults(): array {
	return array(
		 ...
		 * намеренно: офис работает пн–сб 9:00–17:00 и вс 9:00–16:00,
...
function razil_org_field_notes(): array {
	return array(
		'phone'       => 'Основной номер. Выводится в шапке, в мобильном меню, на кнопке «Вызвать специалиста», '
			. 'в липкой панели звонка, на первом экране главной, в блоке «Что делать, если уход наступил дома», '
 ...
 * делать, если уход наступил дома», здесь по нему же они исключаются
